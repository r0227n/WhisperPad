...
allowed-tools: Bash(git status:*), Bash(git status -C *:*), Bash(git diff:*), Bash(git diff -C *:*), Bash(git log:*), Bash(git log -C *:*), Bash(git add:*), Bash(git commit:*), Read, Grep, Glob, TodoWrite, EnterPlanMode, ExitPlanMode
---
