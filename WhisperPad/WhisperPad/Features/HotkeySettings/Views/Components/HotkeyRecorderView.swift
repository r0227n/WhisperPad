...
struct HotkeyRecorderView: View {
    ...
    private func displayString(_ combo: HotKeySettings.KeyComboSettings) -> String {
        ...
        if mods & 4096 != 0 { symbols.append("\u{2303}") } // Control
        if mods & 2048 != 0 { symbols.append("\u{2325}") } // Option
        if mods & 512 != 0 { symbols.append("\u{21E7}") } // Shift
        if mods & 256 != 0 { symbols.append("\u{2318}") } // Command
